...
app.layout = html.Div(children=[
    html.H2('Real-time Twitter Sentiment Analysis for Natural Disasters', style={
        'textAlign': 'center'
    }),
    html.H4('(Last updated: Dec 5, 2021)', style={
        'textAlign': 'right'
    }),
    ...
    html.Div(
        ...
        children = [
            ...
            html.Div(
                className = 'col-md-4 mb-4',
                children = [
                    dcc.Input(id='sentiment_term', className = 'form-control', value='Earthquake', type='text'),
        ...
        children=[
            ...
            html.Div(
                ...
                children=[
                    ...
                    html.A(
                        'GitHub',
                        href='https://github.com/jpvance123/SIU-Twitter-Analytics.git'
                    )                    
                ]
            ),
            html.Div(
...
def update_graph_live(n):
    ...
    df = pd.read_sql(query, con=my_db)
